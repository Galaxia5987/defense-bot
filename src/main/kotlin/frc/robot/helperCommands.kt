...
import frc.robot.RobotContainer.elevator
import frc.robot.RobotContainer.gripperMotor
...
fun runGripper(voltage: Voltage): Command =
    runOnce({ gripperMotor.setVoltage(voltage[volts]) })
...
fun runElevator(voltage: Voltage): Command = elevator.setPower { voltage }
